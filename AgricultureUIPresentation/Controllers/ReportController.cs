    ...
    public class ReportController : Controller
    {
        ...
        public IActionResult ContactReport()
        {
            using (var workBook = new XLWorkbook())
            {
                ...
                workSheet.Cell(1, 4).Value = "Mesaj Başlığı";
                workSheet.Cell(1, 5).Value = "Mesaj İçeriği";
                workSheet.Cell(1, 6).Value = "Mesaj Tarihi";
                ...
                foreach (var item in ContactList())
                {
                    ...
                    workSheet.Cell(contactRowCount, 4).Value = item.ContactTitle;
                    workSheet.Cell(contactRowCount, 5).Value = item.ContactMessage;
                    workSheet.Cell(contactRowCount, 6).Value = item.ContactDate;
